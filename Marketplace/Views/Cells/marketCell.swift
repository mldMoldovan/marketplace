...
class marketCell:UIView{
    ...
    let container:UIStackView = {
        ...
        let b = UIImageView(image: core.man.img("poster1"))
        b.contentMode = .scaleAspectFill
        b.alpha = 0.59
        c.insertArrangedSubview(b, at: 0)
        ...
        let t = UILabel()
        t.text = "Missing Marketname"
        t.textColor = core.man.color("almost_white")
        t.textAlignment = .left
        t.font = UIFont(name: "Helvetica", size: 20)
        t.tag = 1501
        
        
        let d = UILabel()
        d.text = "666 People inside"
        d.textColor = core.man.color("almost_white")
        d.textAlignment = .left
        d.font = UIFont(name: "Helvetica", size: 17)
        d.tag = 1502
